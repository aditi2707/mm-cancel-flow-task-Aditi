...
export default function SubsCancelJobNotFoundByMM() {
        ...
        <div className="p-4">
          <div className="grid grid-cols-5 gap-4">
            ...
            <div className="col-span-3">
                ...
                <p className="leading-none m-0 text-gray-800" style={{"fontFamily": "Arial", "fontSize": "25px"}}>
                    <b>
                        Even if it wasn't through Migrate Mate, <br></br>
